 ...
 *
 *     http://api.mymmsc.org/versioning.html
 */


#define API_COPYRIGHT "Copyright (c) 2000-2014 The MyMMSC Software " \
                      "Foundation(MSF) or its licensors, as applicable."
 ...
 *              information.
 */
API void api_version(api_version_t *pvsn);

/** Return API's version information as a string. */
API const char * api_version_string(void);
