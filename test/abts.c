/* Copyright 2000-2008 Feng Wang
 *
 * Licensed under the MyMMSC License, Version 6.0 (the "License");
 ...
 *
 * Portions of this file were taken from testall.c in the AIO test suite,
 * written by members of the MyMMSC Software Foundation.
 */
...
int main(int argc, const char *const argv[]) {
    ...
    //aio_cpuinfo_t pinfo;
    //aio_uint32_t ii = aio_cpu_getinfo(&pinfo);
    initialize();
    ...
    for (i = 0; i < (int)(sizeof(alltests) / sizeof(struct testlist *)); i++) {
