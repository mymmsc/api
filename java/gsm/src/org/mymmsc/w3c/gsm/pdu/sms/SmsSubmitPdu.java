/**
 * @(#)SmsSubmitPdu.java	6.3.9 09/10/02
 *
 * Copyright 2000-2010 MyMMSC Software Foundation (MSF), Inc. All rights reserved.
 * MyMMSC PROPRIETARY/CONFIDENTIAL. Use is subject to license terms.
 */
package org.mymmsc.w3c.gsm.pdu.sms;
...
public class SmsSubmitPdu extends PduContext {
	// ==================================================
	...
	protected String pduSubclassInfo() {
		...
		case PduUtils.TP_VPF_TIMESTAMP:
			sb
					.append("TP-VPF: "
							+ formatTimestamp(getValidityDateAsCalendar()));
			break;
		}
		sb.append("\n");
		return sb.toString();
