/**
 * @(#)PduContext.java	6.3.9 09/10/02
 *
...
import org.mymmsc.w3c.gsm.pdu.context.PortInformationElement;
...
public abstract class PduContext {
	// PDU class
	...
	private int m_info_type = -1;
	private int m_info_length = 0;
	private int m_info_ops = -1;
	...
	public final String toString() {
		...
		if (udData != null) {
			...
			if (hasTpUdhi()) {
				...
				if (!isBinary()) {
					sb
							.append("User Data (decoded): [" + getDecodedText()
									+ "]");
					sb.append("\n");
				}
			}
	...
	/**
	 * @param m_info_type
	 *            the m_info_type to set
	 */
	public void setInfoType(int info_type) {
		this.m_info_type = info_type;
	}

	/**
	 * @return the m_info_type
	 */
	...
	/**
	 * @param info_length
	 *            the m_info_length to set
	 */
	public void setInfoLength(int info_length) {
		this.m_info_length = info_length;
	}

	/**
	 * @return the m_info_length
	 */
	public int getInfoLength() {
		return m_info_length;
	}

	/**
	 * @param info_ops the m_info_ops to set
	 */
	public void setInfoOps(int info_ops) {
		this.m_info_ops = info_ops;
	}

	/**
	 * @return the m_info_ops
	 */
	public int getInfoOps() {
		return m_info_ops;
	}
}
