...
public class HttpDownload {
	 ...
	 *            超时秒数
	 */
	public HttpDownload(String url, int timeout) {
		this.url = url;
	 ...
	 */
	public HttpURLConnection post(Map<String, String> headers, Object body) {
		...
		try {
			...
			if (httpStatus == 200) {
				...
				if (cookie != null && cookiePath != null) {
